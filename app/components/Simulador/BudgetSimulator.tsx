    ...
    <div className={estimateReady ? "simulator-shell ready" : "simulator-shell"}>
      <section className="simulator-intro">
        <div>
          ...
          <h3>Primero entendemos la boda. Después hablamos de números.</h3>
          <p>
            Empezamos por lo que importa: cuántos sois, dónde lo celebráis y qué logística necesitan vuestros invitados.
            Después abrimos el baremo con calma.
          </p>
        </div>
        <div className="simulator-test-card">
          ...
          <div className="question-group">
            <span>De dónde vienen los invitados</span>
            <div className="choice-grid">
              <button className={guestOrigin === "local" ? "choice active" : "choice"} onClick={() => setGuestOrigin("local")} type="button">Mayoría local</button>
      ...
      {!estimateReady && (
        <section className="quiet-state">
          <p className="eyebrow">Todavía sin presupuesto</p>
          <h3>Introduce invitados y destino para abrir el baremo.</h3>
          <p>Así evitamos enseñar una cifra demasiado pronto y mantenemos la conversación natural.</p>
        </section>
      )}

      {estimateReady && (
        <>
          <section className="preset-row" style={{ display: "flex", flexWrap: "wrap", gap: "10px", margin: "16px 0" }} aria-label="Escenarios rápidos">
                        ...
                        <div className="simulator-option-body">
                          <div className="simulator-option-top">
                            <label className="toggle-card">
                              ...
                              <span>{selected ? "Incluido" : "Añadir módulo"}</span>
                            </label>
                          ...
                          <div className="price-designer">
                            ...
                            <label className="manual-price">
                              {option.unit === "guest" ? "Precio por invitado" : "Precio del módulo"}
                              <input
                                disabled={!selected}
                                max={maxValue}
                                min={minValue}
                          ...
                          <div className="option-price-row">
                            <span>{option.unit === "guest" ? "total según invitados" : "total módulo"}</span>
          ...
          <div className="simulator-bottom-bar">
            ...
            <div className="contribution-control">
              <span>Aportación pareja: {currency(coupleContribution)}</span>
